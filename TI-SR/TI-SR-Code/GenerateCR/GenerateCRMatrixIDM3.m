...
function [CRMatrix_sum, PETDistribution, feasibleFlag] = calculate_CR_matrix(TrainingFlag)
    ...
    if TrainingFlag == 0  %MSF
        ...
        data_speed = readmatrix('/home/drivesim/Documents/SR/MSFTrainData/speed36_2PySR.csv');
        data_accel = readmatrix('/home/drivesim/Documents/SR/MSFTrainData/accel36_2PySR.csv');
        data_distance = readmatrix('/home/drivesim/Documents/SR/MSFTrainData/distanceAtk36_2PySR.csv');
        data_latdev = readmatrix('/home/drivesim/Documents/SR/MSFTrainData/latdev36_2PySR.csv');
    end
...
udp_socket = udpport("LocalPort", 50034);
...
while true
    ...
    if ~isempty(data_received)
        ...
        write(udp_socket, data_bytes, "LocalHost", 50033);
