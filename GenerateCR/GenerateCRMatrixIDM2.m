...
function [CRMatrix_sum, PETDistribution, feasibleFlag] = calculate_CR_matrix(TrainingFlag)
    ...
    if TrainingFlag == 0  %MSF
        ...
        data_speed = readmatrix('/home/drivesim/Documents/SR/MSFTrainData/speed36_1PySR.csv');
        data_accel = readmatrix(['/home/drivesim/Documents/SR/MSFTrainData/accel36_1PySR.csv']);
        data_distance = readmatrix('/home/drivesim/Documents/SR/MSFTrainData/distanceAtk36_1PySR.csv');
        data_latdev = readmatrix('/home/drivesim/Documents/SR/MSFTrainData/latdev36_1PySR.csv');
    end
...
udp_socket = udpport("LocalPort", 50032);
...
while true
    ...
    if ~isempty(data_received)
        ...
        write(udp_socket, data_bytes, "LocalHost", 50031);
